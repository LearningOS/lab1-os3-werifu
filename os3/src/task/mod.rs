...
lazy_static! {
    ...
    pub static ref TASK_MANAGER: TaskManager = {
        ...
        let mut tasks = [TaskControlBlock {
            ...
            task_info_inner: TaskInfoInner { syscall_times: [0; MAX_SYSCALL_NUM], start_time: 0 }
        }; MAX_APP_NUM];
...
impl TaskManager {
    ...
    // fn get_current_task_info(&self) -> TaskInfoInner {
    //     let inner = &self.inner.exclusive_access();
    //     let cur_id = inner.current_task;
    //     inner.tasks[cur_id].task_info_inner
    // }
